...
$getDataU = mysqli_query($koneksi, "SELECT * FROM uptodomhs where IdTodo= '$IdTodo' AND EmailMhs ='$EmailMhs'");
?>
<html>
<head>
        <meta charset="utf-8" />
    ...
    <script type="text/javascript">
        <?php
            $idt=$IdTodo;
            $getTodo = mysqli_query($koneksi, "SELECT * FROM todo where IdTodo= '$IdTodo'");
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        while ($rowT= mysqli_fetch_array($getDataT)) {
                            echo '
                            <a class="card mb-4 text-center" href="upact.php?IdTodo='.$IdTodo.'&TglSTodo='.$rowT['TglSTodo'].'">
                                <button type="button" class="btn btn-embossed btn-info btn-xs" style="padding-right:-20">Upload Activity</button>
                            </a>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="" method="">                                
