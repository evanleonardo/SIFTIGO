            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">My Activity Recap</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="team.php">Team</a></li>
                            <li class="breadcrumb-item active">Recap</li>
                        </ol>
                        </br>
                        <a class="card mb-4 text-center" href=<?php echo'"exportrecap.php?emailmhs='.$emailmhs.'"'?>>
                            <button type="button" class="btn btn-embossed btn-info btn-xs" style="padding-right:-20">Download Recap PDF</button>
                        </a>
                        <div class="card mb-4">                            
