...
$getAct = mysqli_query($koneksi, "SELECT * FROM todo where stattodo ='1' and tahun ='$tahun'");
?>
<html>
<head>
        <meta charset="utf-8" />
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <a class="card mb-4 text-center" href=<?php echo'"exportlogbook.php?tahun='.$tahun.'&emailmhs='.$emailmhs.'"'?>>
                            <button type="button" class="btn btn-embossed btn-info btn-xs" style="padding-right:-20">Download Logbook Activity</button>
                        </a>
                        <div class="card mb-4">
