            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="faddteam.php" method="POST">
                                            <div class="row mb-3">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="NamaTim" name="NamaTim" type="text" placeholder="Enter team name" required>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="tahun" name="tahun" type="text" placeholder="Enter year" required>
